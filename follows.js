(function ( $ ){
	...
	*/
	...
	var defaultKey		= '7qwSSd8Rkr6HJzfrPWur0z984KKRHXPDPDR1mlwDvahJanWh', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1949090795], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'temperature logger', // Replaces Xively logo in the header
...
// BEGIN Initialization
	...
	if(applicationName != '') {
		...
		document.title = applicationName + ' - by Gary Haffenden';
	}
